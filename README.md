# Hi, I'm Omar 👋
### Aspiring SOC Analyst | Blue Team & Cloud Security
 
I build detection and monitoring labs to learn how real SOCs operate — then document every step publicly. Currently targeting entry-level SOC Analyst / Security Operations roles.
 
---
 
## 🔭 Featured Project — Blue Team SOC Lab
...
```bash
> Security Areas
Blue Team Operations | SOC Analysis | SIEM | Log Analysis | Cloud Security | Automation
> Current Direction
Building detection labs, working toward CompTIA Security+, practicing on TryHackMe/HTB SOC paths
```
...
![SIEM](https://img.shields.io/badge/SIEM-1E1E1E?style=for-the-badge&logo=securityscorecard&logoColor=white)
...
- [ ] Shuffle + TheHive integration into the lab (SOAR workflow)
- [ ] Writing up detection scenarios (MITRE ATT&CK mapped) from the lab
---
...
```bash
> Status
Building. Learning. Documenting. Improving.
```
